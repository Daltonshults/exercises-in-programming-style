...
data_storage_obj['init'](
    '/mnt/c/Users/Dalto/Documents/software_development/ExercisesInProgrammingStyle/exercises-in-programming-style/pride-and-prejudice.txt')
stop_words_obj['init']()
